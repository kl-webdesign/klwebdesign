...
const webDesignMobile = document.querySelector('#design-mobile');
...
window.addEventListener('scroll', () => {
  ...
  webDesignMobile.style.color = `rgb(${c}, ${c}, ${c})`;
  webDesignMobile.style.backgroundColor = `rgb(${255-c}, ${255-c}, ${255-c})`;
